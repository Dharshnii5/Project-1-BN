package codes.employee.my_project.controller;

import codes.employee.my_project.model.Employee;
import codes.employee.my_project.service.EmployeeService;
...
public class EmployeeController {
    ...
    public String updateEmployee(@ModelAttribute("employee") Employee employee) {
        employeeService.save(employee); // Use save method to update employee
